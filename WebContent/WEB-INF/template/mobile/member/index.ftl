...
<body class="profile">
	...
	<footer class="footer-fixed">
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-3 text-center">
					<a href="${base}/"><span class="glyphicon glyphicon-home"></span>
					${message("member.common.index")}</a>
				</div>
				<div class="col-xs-3 text-center">
					<a href="${base}/product_category"><span class="glyphicon glyphicon-th-list"></span>
					${message("member.common.productCategory")}</a>
				</div>
				<div class="col-xs-3 text-center">
					<a href="${base}/cart/list"><span class="glyphicon glyphicon-shopping-cart"></span>
					${message("member.common.cart")}</a>
				</div>
				<div class="col-xs-3 text-center active">
					<a href="${base}/member/index"><span class="glyphicon glyphicon-user"></span>
					${message("member.common.member")}</a>
				</div>
			</div>
		</div>
	</footer>
